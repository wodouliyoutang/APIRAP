...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text"></i>编辑权限</h3>
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-align-left"></i>编辑权限</li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-indent red"></i><strong>编辑权限</strong></h2>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="addRuleForm">
                        <?php if($data['pidName']): ?><div class="form-group">
                                <label class="col-lg-2 col-md-2 col-sm-12 control-label">父类名称</label>
                                <div class="col-lg-10 col-md-10">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3">
                                            <input type="text" class="form-control" name="pidname" value="<?php echo ($data['pidName']); ?>" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                            </div><?php endif; ?>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <input type="text" class="form-control" name="rule_title" value="<?php echo ($data['title']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3">
                                        <input type="text" class="form-control" name="rule_name" value="<?php echo ($data['name']); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1 col-sm-2 col-xs-3" style="padding-top: 7px;">
                                        <label class="switch switch-primary">
                                            <input type="checkbox" class="switch-input" name="status" <?php if($data['status']): ?>checked=""<?php endif; ?>  >
