...
<div class="main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text"></i>添加用户组</h3>
            <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/Admin" class="Noline">首页</a></li>
                <li><i class="fa fa-github-alt"></i><a href="<?php echo U('Auth/group');?>" class="Noline">用户组列表</a></li>
                <li><i class="fa fa-align-left"></i>添加用户组</li>
                <li id="no-be"><i class="fa fa-mail-reply"></i><a href="<?php echo U('Auth/group');?>" class="Noline">返回上一级</a></li>
            </ol>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h2><i class="fa fa-indent red"></i><strong>添加用户组</strong></h2>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" id="addGroupForm">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-12 control-label">用户组名</label>
                                ...
                                <div class="row">
                                    <div class="col-md-1 col-sm-2 col-xs-3" style="padding-top: 7px;">
                                        <label class="switch switch-primary">
                                            <?php if($data): ?><input type="checkbox" class="switch-input" <?php if($data['status']): ?>checked<?php endif; ?> name="status">
                                                <?php else: ?>
                                                <input type="checkbox" class="switch-input" checked="" name="status"><?php endif; ?>
