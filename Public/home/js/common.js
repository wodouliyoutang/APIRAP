$(function(){
	...
	/*登录TAB表格切换*/
	$(document).on('click','#rl-modal-header span',function(e){
	 ...
	 * 处理表情
	 */
	$(document).on('click','#smilelink img',function(e){
	...
	//点击回复评论
	$(document).on('click','#show-content .comment-reply-link',function(e){
		//清空
		$("#comment").val('');
		var uid = $("#uids").val();
		if (!uid) {
