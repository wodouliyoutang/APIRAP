...
<link rel="stylesheet" href="/Public/css/item/show.css?1.1d.1thdddefghi1" />

<div class="doc-head row" >
  <div class="left "><h4><?php echo ($item["item_name"]); ?></h4></div>
  <div class="right">
      ...
      <?php if($ItemPermn): ?><li>
          ...
          <!-- dropdown menu links -->
            <li><a href="#" id="share"><?php echo (L("share")); ?></a></li>
             <li><a href="<?php echo U('Home/Item/export',array('item_id'=>$item['item_id']));?>"><?php echo (L("export")); ?></a></li>
  ...
  <!-- 左侧栏菜单 -->
    <div class="doc-left span3 bs-docs-sidebar pull-left">
      ...
      <div class="doc-left-newbar">
        ...
        <?php if($ItemPermn && !$item['is_archived']): ?><div><a title="<?php echo (L("new_page")); ?>" href="<?php echo U('Home/Page/edit',array('item_id'=>$item['item_id'],'type'=>'new'));?>" id="new-like"><i class="icon-plus"></i>&nbsp;</a>
            <a title="<?php echo (L("new_or_edit_catalog")); ?>" href="<?php echo U('Home/Catalog/edit',array('item_id'=>$item['item_id']));?>" id="dir-like" ><i class="icon-folder-open"></i></a>
          </div><?php endif; ?>
    ...
    <div class="doc-right  span12 ">
      ...
      <div class='page-edit-link pull-right hide'>
        <ul class="inline">
            <li><a class="btn btn-link" href="" id="share-page" title="<?php echo (L("share_address_to_your_friends")); ?>"><?php echo (L("share")); ?></a></li>
          <?php if($ItemPermn && !$item['is_archived']): ?><li><a class="btn btn-link" href="" id="edit-link" title="<?php echo (L("edit_interface")); ?>"><?php echo (L("edit")); ?></a></li>
            <li>
              <div class="btn-group">
                  <a class="btn btn-link dropdown-toggle" data-toggle="dropdown" href="#">
          ...
          <?php else: ?>
              <li><a href="" data-page_id= "0" class="show_page_info" title="详情">详情</a></li><?php endif; ?>
        </ul>
      </div>
      <!-- 页面内容 -->
...
<script src="/Public/js/item/show.js?v=1.21212345678901234567"></script>