...
<link rel="stylesheet" href="/Public/css/item/index.css?v=1.234" />
    <div class="container-narrow">
      ...
      <div class="masthead">
        ...
        <a class="btn btn-link" href="https://github.com/star7th/showdoc/issues" target="_blank"><?php echo (L("feedback")); ?></a>
    ...
    <div class="container-thumbnails">
      <ul class="thumbnails">
        ...
        <?php if(is_array($items)): foreach($items as $key=>$item): ?><li class="span3 text-center">
            <a class="thumbnail item-thumbnail" href="<?php echo U('Home/Item/show',array('item_id'=>$item['item_id']));?>" title="<?php echo ($item["item_description"]); ?>">
              <span class="item-setting" data-src="<?php echo U('/home/item/setting',array('item_id'=>$item[item_id]));?>"  title="项目设置">
                <i class="icon-wrench" ></i>
              </span>

              <?php if($item['top']): ?><span class="item-top" data-action="cancel" data-item_id="<?php echo ($item["item_id"]); ?>" title="取消置顶"><i class="icon-arrow-down" ></i></span>
              <?php else: ?>
                  <span class="item-top" data-action="top" data-item_id="<?php echo ($item["item_id"]); ?>" title="置顶项目"><i class="icon-arrow-up"  ></i></span><?php endif; ?>
...
<div class="modal hide fade" id="share-home-modal">
 ...
 <script src="/Public/js/item/index.js?v=1"></script>