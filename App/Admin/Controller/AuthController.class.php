...
class AuthController extends AdminBaseController {
    ...
    public function group(){
        ...
        if ($t == 1) {
			...
			if(IS_PJAX){
				$data['html'] = $this->fetch('listGroup');
				$this->ajaxReturn($data);
			}
